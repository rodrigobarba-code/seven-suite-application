...
CREATE TABLE `interface` (
  ...
  `fk_router_id` int DEFAULT NULL,
  `interface_state` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `ip_addresses_configuration` (
  ...
  `fk_ip_address_interface` int DEFAULT NULL,
  `ip_address_alias` varchar(512) DEFAULT NULL,
  `ip_address_state` varchar(64) DEFAULT NULL,
  `ip_address` varchar(64) DEFAULT NULL,
  `ip_address_netmask` varchar(64) DEFAULT NULL,
  `ip_address_network` varchar(64) DEFAULT NULL,
  `ip_address_gateway` varchar(64) DEFAULT NULL,
...
CREATE TABLE `session_information` (
  ...
  `session_hostname` varchar(512) DEFAULT NULL,
  `session_username` varchar(256) DEFAULT NULL,
  `session_password` varchar(256) DEFAULT NULL,
  `session_connection_type` varchar(64) DEFAULT NULL,
  `session_brand` varchar(64) DEFAULT NULL,
  `session_model` varchar(64) DEFAULT NULL,
  `allow_remote_access` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `session_port` (
  `session_port_id` int DEFAULT NULL,
  `fk_session_id` int DEFAULT NULL,
  `port_number` int DEFAULT NULL,
  `port_status` tinyint(1) DEFAULT NULL,
  `port_protocol` varchar(64) DEFAULT NULL,
  KEY `fk_session_id` (`fk_session_id`),
...
-- Dump completed on 2024-07-02 16:30:20
